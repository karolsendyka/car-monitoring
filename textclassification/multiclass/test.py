...
local_file_path = "arxiv_data.csv"
url = "https://github.com/soumik12345/multi-label-text-classification/releases/download/v0.2/arxiv_data.csv"

# Check if the file already exists
if os.path.exists(local_file_path):
    print("Loading data from local file...")
    arxiv_data = pd.read_csv(local_file_path)
else:
    print("Downloading data from URL...")
    arxiv_data = pd.read_csv(url)
    # Save the downloaded file to disk
    arxiv_data.to_csv(local_file_path, index=False)
